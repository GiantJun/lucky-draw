...
首次打开应用或重置数据后，系统会自动加载默认配置：
- 👥 **20个正职人员**：张三、李四、王五等（每人额外抽奖次数为3）
- 🎁 **完整奖品配置**：
  - 特等奖：iPad Air × 1
  - 一等奖：6个奖品（手机、相机等）
  - 二等奖：5个奖品（音箱、平板等）
  - 三等奖：4个奖品（空气炸锅、吹风机等，每个5份）

💡 **提示**：可直接点击"开始"按钮进行抽奖，无需额外配置！
...
- ✅ 完全透明公正，无暗箱操作
- 💾 数据存储在浏览器本地，刷新不丢失
- 🚀 **开箱即用** - 内置默认配置，无需导入即可体验
- 🌐 建议使用 Chrome 浏览器
- 🎵 背景音乐加载较慢，可提前打开缓存
- 📱 支持不同分辨率屏幕，自动适配最佳显示效果
